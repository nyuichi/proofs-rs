...
export const demoRecords: RecordInput[] = [
 {api_path:'fnv::FnvHasher::default',api_kind:'method',api_safety:'safe',contract_language:'kani',tag:'no-panic',contract:'',configuration:'default features; x86_64-unknown-linux-gnu',run_index:0,result_index:0},
 {api_path:'fnv::FnvHasher::write',api_kind:'method',api_safety:'safe',contract_language:'kani',tag:'no-panic',contract:'kani::assume(bytes.len() <= 16);',configuration:'default features; x86_64-unknown-linux-gnu; bounded demo, unwind 17',run_index:0,result_index:1},
 {api_path:'fnv::FnvHasher::finish',api_kind:'method',api_safety:'safe',contract_language:'kani',tag:'no-panic',contract:'',configuration:'default features; x86_64-unknown-linux-gnu',run_index:0,result_index:2},
 {api_path:'fnv::FnvHasher::write',api_kind:'method',api_safety:'safe',contract_language:'kani',tag:'no-ub',contract:'',configuration:'default features; x86_64-unknown-linux-gnu; synthetic unconditional assertion (not a verifier run)',run_index:0,result_index:3},
];
